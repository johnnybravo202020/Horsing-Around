...
class FixtureScrapper(BaseRaceDayScrapper):
    ...
    def set_test_model(self):
        ...
        self.test_model = FixtureTestData
...
class ResultScrapper(BaseRaceDayScrapper):
    ...
    def set_test_model(self):
        from scrapper.models.test import ResultTestData
        self.test_model = ResultTestData
...
class HorseScrapper(BasePageScrapper):
    ...
    def __init__(self, horse_id, html='', url='', save_data_for_test=False):
        self.horse_id = horse_id
        super(HorseScrapper, self).__init__(html, url, save_data_for_test)
    ...
    @classmethod
    def scrap(cls, horse_id, save_data_for_test=True):
        """
        ...
        """
        scrapper = cls(horse_id, save_data_for_test=save_data_for_test)
        return scrapper.get()
