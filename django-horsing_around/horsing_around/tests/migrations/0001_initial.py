# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-23 22:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html_row', models.TextField()),
                ('race_day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='results', to='tests.RaceDayTestData')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='race_day',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fixtures', to='tests.RaceDayTestData'),
        ),
    ]
